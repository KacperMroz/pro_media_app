...
class _$HomeStateImpl extends _HomeState {
  const _$HomeStateImpl({this.isVideoPlaying = false}) : super._();
  ...
  @override
  String toString() {
    return 'HomeState(isVideoPlaying: $isVideoPlaying)';
  }
...
abstract class _HomeState extends HomeState {
  const factory _HomeState({final bool isVideoPlaying}) = _$HomeStateImpl;
